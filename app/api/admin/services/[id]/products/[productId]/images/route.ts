...
export async function POST(request: Request, context: { params: { id: string; productId: string } }) {
  try {
    ...
    const storagePath = `services/${tenantId}/${serviceId}/${productId}/${imageId}.${ext}`
