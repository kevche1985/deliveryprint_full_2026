...
export async function PUT(request: Request, context: { params: { id: string; productId: string } }) {
  try {
    ...
    const { data, error } = await supabaseServer.rpc("admin_replace_service_product_variants", {
