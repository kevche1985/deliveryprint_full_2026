-- Final migration to ensure email templates exist with correct permissions
-- This uses the service_role to bypass RLS completely

-- Insert templates using service_role permissions
