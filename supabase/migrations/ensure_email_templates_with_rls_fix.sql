-- First, ensure the email templates exist with proper RLS bypass
-- This migration should be run with service role privileges
...
-- Create permissive policies for server operations
CREATE POLICY "email_templates_server_access" ON email_templates FOR ALL USING (true);
CREATE POLICY "email_settings_server_access" ON email_settings FOR ALL USING (true);
CREATE POLICY "email_logs_server_access" ON email_logs FOR ALL USING (true);
